...
public class ResourceMessageConfiguration implements WebMvcConfigurer {
	...
	public MessageSource messageSource() {
		...
		messageSource.setBasename("classpath:messages"); // Va a tomar mensajes desde un archivo messages.properties
	...
	public SessionLocaleResolver localeResolver() {
		...
		localeResolver.setDefaultLocale(Locale.ENGLISH); // Por defecto muestra los mensajes en English
		// Salvo que yo escriba en el message.properties en español
